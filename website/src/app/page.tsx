      ...
      <div className="relative z-10">
        ...
        <nav className="flex justify-between items-center p-6 max-w-7xl mx-auto">
          <div className="flex items-center space-x-3">
            <Image
              src="/logo_fairify.png"
              alt="Fairify.ai Logo"
              width={40}
              height={40}
              className="rounded-lg"
            />
            <span className="text-2xl font-bold text-white">Fairify.ai</span>
          </div>
          <div className="hidden md:flex space-x-8">
            <a href="#about" className="text-gray-300 hover:text-white transition-colors">About</a>
            <a href="#impact" className="text-gray-300 hover:text-white transition-colors">Impact</a>
            <a href="#principles" className="text-gray-300 hover:text-white transition-colors">Principles</a>
        ...
        <section className="text-center py-20 px-6 max-w-6xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed">
            Revolutionizing data sharing with privacy-preserving FAIR principles. 
            Making data Findable, Accessible, Interoperable, and Reusable while protecting your privacy.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button className="border-2 border-gray-400 text-gray-300 px-8 py-4 rounded-lg text-lg font-semibold hover:border-white hover:text-white transition-all">
              Learn More
            </button>
          </div>
        </section>
        ...
        <section id="principles" className="py-20 px-6 max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              {
                title: 'Findable',
                description: 'Data and metadata are easily discoverable by both humans and computers',
                icon: '🔍',
                color: 'from-blue-500 to-blue-600'
              },
              {
                title: 'Accessible',
                description: 'Data can be retrieved and accessed with appropriate authentication and authorization',
                icon: '🔓',
                color: 'from-green-500 to-green-600'
              },
              {
                title: 'Interoperable',
                description: 'Data can be integrated with other data and used by applications',
                icon: '🔗',
                color: 'from-purple-500 to-purple-600'
              },
              {
                title: 'Reusable',
                description: 'Data can be used for research, learning, and other purposes',
                icon: '♻️',
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-300 text-lg leading-relaxed">
                By implementing FAIR principles with privacy protection, we can unlock the full potential of data 
                while maintaining individual rights and security.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="about" className="py-20 px-6 max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-4xl mx-auto">
              We're developing cutting-edge technology to enable FAIR data sharing in a privacy-preserving manner, 
              bridging the gap between data accessibility and individual privacy rights.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-gray-300 text-lg leading-relaxed">
                To democratize data access while preserving privacy, enabling researchers, businesses, and 
                organizations to leverage the power of FAIR data principles without compromising individual rights.
              </p>
              ...
              <div className="bg-gradient-to-r from-blue-500/20 to-purple-500/20 rounded-2xl p-8 border border-white/10">
                <div className="text-center">
                  ...
                  <p className="text-gray-300">
                    Building the future of data sharing with AI-powered privacy protection
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto text-center">
            <div className="flex items-center justify-center space-x-3 mb-6">
              <Image
                ...
                className="rounded-lg"
              />
              <span className="text-xl font-bold text-white">Fairify.ai</span>
            </div>
